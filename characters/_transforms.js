...
module.exports = function buildTransforms(img) {
  return {
    ...
    // ---------- ทาคายามะ จิน ----------
    //  seconds วัดจาก mvhd atom จริง (+buffer ~1 วิ กันตัดก่อนจบ):
    //  jin_skill3 19.69 / jin_passive 12.12 / jin_passive2 4.67 / jin_passive3 18.78 วิ
    ...
    jinThisIsMe:  { img: "/characters/jin/jin.webp", video: "/characters/jin/passive/jin_passive3.mp4", title: "นี่แหละตัวฉัน", label: "สวนกลับ", seconds: 20, music: null, afterReveal: false },
  };
};
