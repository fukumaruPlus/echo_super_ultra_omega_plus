...
module.exports = {
  ...
  // เกราะของรถ = พลังชีวิตของรถ ไม่ใช่เกราะจริง จึงห้ามฟื้นเองตามจังหวะปกติของสนาม
  //  (ไม่งั้นรถซ่อมตัวเองฟรีทุก 2 เทิร์น และแทบไม่มีวันพังถ้าโดนตีเบาๆ ขัดกับ "ถาวรจนกว่ารถจะพัง")
  //  เรียกจาก dealRound() ตรงจุดฟื้นเกราะรอบเลขคู่
  blocksArmorRegen(p) { return this.inCar(p); },
