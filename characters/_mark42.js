// ============================================================
//  เกราะ Mark 42 — ไอเทมร้านค้ามายา (15 เหรียญ) ที่ใครก็ใส่ได้ (ยกเว้น ORT)
//  ไฟล์นี้ไม่ใช่ตัวละคร (ไม่อยู่ใน CHAR_HOOKS) — server.js require ตรงเหมือน _universal_status
//
//  ใช้ได้ 3 แบบ (ช่วงจั่วการ์ด): ใส่ให้ตัวเอง · ใส่ให้ผู้เล่นอื่น · ใส่ให้ผู้เล่นอื่นแล้วระเบิดทันที (ความเสียหาย 4)
...
module.exports = {
  ...
  // ระเบิด: ชุด (ถ้ามี) พังก่อน แล้วความเสียหาย 4 ลงตัวจริงของคนใส่ (ลดเกราะก่อน)
