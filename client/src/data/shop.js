const SHOP_ITEM_INFO = {
  ...
  mark42: { icon: "🦾", img: "/characters/Mark42/mark42_item.jpg", label: (it) => `เกราะ Mark 42${it.armor && it.armor < 7 ? ` (${it.armor}/7)` : ""}`, desc: "ใช้ช่วงจั่วการ์ด: ใส่ให้ตัวเอง / ใส่ให้ผู้เล่นอื่น / ใส่ให้ผู้เล่นอื่นแล้วระเบิดทันที (ความเสียหาย 2) — ใส่แล้วพลังชีวิตกลายเป็นเกราะชุด 7 หน่วย พลังโจมตี +1 ชุดพัง = กลับร่างเดิม · เจ้าของเรียกคืน/ถอด/สั่งระเบิดได้ตลอด · ชุดพังจากการต่อสู้ ซื้อใหม่ไม่ได้ 10 เทิร์น" },
